...
white="${dir}/code/pachi -e montecarlo -t _1 -T 8"
black="${dir}/code/pachi -e montecarlo -t _1 -T 8"
...
## play multiple games##
games=1
${goguitwogtp} -black "${black}" -white "${white}" -size 7 -auto -games ${games} -sgffile test -time 10 -verbose >gtg_output.txt 2>&1
